...
def parse():
    parser = argparse.ArgumentParser(prog='titor:main.py')

    # Initialize subparsers
    subparsers = parser.add_subparsers(title='subcommands', description='valid subcommands', help='additional help', dest='main_subparser')
